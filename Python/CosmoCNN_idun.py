...
train_dataset = dataset_from_png(n_samples=n_train_samples, size=img_size, folder="Cosmo_Ai/Python/train", gen_new=gen_new_train)
train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=True)
test_dataset = dataset_from_png(n_samples=n_test_samples, size=img_size, folder="Cosmo_Ai/Python/test", gen_new=gen_new_test)
